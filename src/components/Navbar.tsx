...
const Navbar = () => {
  ...
  const handleNavClick = (section: string) => {
    // Aqui você pode adicionar navegação para seções específicas quando implementar
    setIsMenuOpen(false);
  };
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="tactical" size="sm" onClick={handleLogin}>
              Entrar
            </Button>
          ...
          <div className="md:hidden absolute top-16 left-0 w-full bg-background border-b border-jungle-primary/20 animate-fade-in">
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="flex flex-col space-y-2 pt-4">
                <Button variant="tactical" size="sm" className="w-full" onClick={handleLogin}>
                  Entrar
                </Button>
                <Button variant="hero" size="sm" className="w-full" onClick={handleSignUp}>
                  Inscreva-se no Site
                </Button>
              </div>
            </div>
